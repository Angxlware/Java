...
public class CDF_E2_Modelado extends javax.swing.JInternalFrame 
{   
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imágenes_CDF/CalcularZ_Modelo_UML.png"))); // NOI18N
        jPanel3.add(jLabel2);
        jLabel2.setBounds(0, 0, 560, 300);

        jPanel1.add(jPanel3);
        jPanel3.setBounds(20, 70, 560, 300);
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        Menú_FRM.objFlujoModeloE2 = null;
        itmFlujoModeloE2.setEnabled(true);
        itmFlujoModeloE2.setText(nombreProblema);
    }//GEN-LAST:event_formInternalFrameClosed

    private void formInternalFrameIconified(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameIconified
        this.setTitle("CDF, E2: Modelado");
