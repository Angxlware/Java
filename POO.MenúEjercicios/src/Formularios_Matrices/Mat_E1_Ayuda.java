...
public class Mat_E1_Ayuda extends javax.swing.JInternalFrame 
{   
    ...
    private void initComponents() {
        ...
        txtArMatriz.setText("- ¿Qué hace el programa?\n   Es un algoritmo que genera una matriz aleatoria de filas y columnas dadas por\n   el usuario para después multiplicar la primer fila por el escalar y sumárselo a la\n   última fila.\n\n- ¿Qué datos necesito ingresar y qué significan?\n   - Filas: Número de filas de la matriz (Número entero mayor que uno)\n   - Columnas: Número de columnas de la matriz (Número entero mayor que uno\n     y distinto al número de filas)\n   - Escalar: Número por el que se multiplicarán los valores (Cualquier número)\n\n- ¿Qué procesos se realizan?\n   - Se genera la matriz\n   - Se multiplica la primer fila por el escalar y se suma a la última fila\n\n- ¿Qué datos me muestra el programa?\n   - La matriz generada\n   - La matriz resultante");
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        Menú_FRM.objMatAyudaE1 = null;
        itmMatAyudaE1.setEnabled(true);
        itmMatAyudaE1.setText(nombreProblema);
