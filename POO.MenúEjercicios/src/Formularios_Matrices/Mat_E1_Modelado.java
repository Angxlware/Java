...
{   
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imágenes_Matrices/EscalarMatriz_Modelo_UML.png"))); // NOI18N
        jPanel3.add(jLabel2);
        jLabel2.setBounds(0, 0, 560, 260);

        jPanel1.add(jPanel3);
        jPanel3.setBounds(20, 70, 560, 260);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(20, 20, 600, 350);
        ...
        jPanel2.setBounds(20, 390, 600, 90);
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        Menú_FRM.objMatModeloE1 = null;
        itmMatModeloE1.setEnabled(true);
        itmMatModeloE1.setText(nombreProblema);
    }//GEN-LAST:event_formInternalFrameClosed

    private void formInternalFrameIconified(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameIconified
        this.setTitle("Mat, E1: Modelado");
