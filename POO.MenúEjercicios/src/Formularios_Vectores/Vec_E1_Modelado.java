...
{   
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imágenes_Vectores/EscalarArreglo_Modelo_UML.png"))); // NOI18N
        jPanel3.add(jLabel2);
        jLabel2.setBounds(0, 0, 560, 290);

        jPanel1.add(jPanel3);
        jPanel3.setBounds(20, 70, 560, 290);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(20, 20, 600, 380);
        ...
        jPanel2.setBounds(20, 420, 600, 90);
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        Menú_FRM.objVecModeloE1 = null;
        itmVecModeloE1.setEnabled(true);
        itmVecModeloE1.setText(nombreProblema);
    }//GEN-LAST:event_formInternalFrameClosed

    private void formInternalFrameIconified(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameIconified
        this.setTitle("Vec, E1: Modelado");
