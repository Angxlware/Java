...
public class Vec_E2_Ayuda extends javax.swing.JInternalFrame 
{   
    ...
    private void initComponents() {
        ...
        txtArMatriz.setText("- ¿Qué hace el programa?\n   Es un algoritmo que genera un arreglo aleatorio de una longitud dada por el\n   usuario para después encontrar y mostrar el número mayor, el número menor, \n   las repeticiones de cada uno y en qué posiciones se encuentran.\n\n- ¿Qué datos necesito ingresar y qué significan?\n   - Longitud: El número de datos del arreglo (Número entero mayor que uno)\n\n- ¿Qué procesos se realizan?\n   - Se genera el arreglo\n   - Se calcula el número mayor\n   - Se calcula el número menor\n   - Se calculan las repeticiones del número mayor\n   - Se calculan las repeticiones del número menor\n   - Se encuentran las posiciones del número mayor\n   - Se encuentran las posiciones del número menor\n\n- ¿Qué datos me muestra el programa?\n   - El número mayor\n   - El número menor\n   - Las repeticiones del número mayor\n   - Las repeticiones del número menor\n   - Las posiciones del número mayor\n   - Las posiciones del número menor");
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        Menú_FRM.objVecAyudaE2 = null;
        itmVecAyudaE2.setEnabled(true);
        itmVecAyudaE2.setText(nombreProblema);
    }//GEN-LAST:event_formInternalFrameClosed

    private void formInternalFrameIconified(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameIconified
        this.setTitle("Vec, E2: Ayuda");
