...
public class Vec_E5_Ayuda extends javax.swing.JInternalFrame 
{   
    ...
    private void initComponents() {
        ...
        txtArMatriz.setText("- ¿Qué hace el programa?\n   Es un algoritmo que genera un arreglo de temperaturas ambientales de una \n   longitud dada por el usuario para después evaluar y mostrar su promedio y las\n   temperaturas superiores al promedio.\n\n- ¿Qué datos necesito ingresar y qué significan?\n   - Longitud: El número de datos del arreglo (Número entero mayor que uno)\n\n- ¿Qué procesos se realizan?\n   - Se genera el arreglo de temperaturas\n   - Se promedian las temperaturas\n   - Se encuentran las temperaturas superiores al promedio\n\n- ¿Qué datos me muestra el programa?\n   - Las temperaturas generadas\n   - El promedio de temperatura\n   - Las temperaturas superiores al promedio");
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        Menú_FRM.objVecAyudaE5 = null;
        itmVecAyudaE5.setEnabled(true);
        itmVecAyudaE5.setText(nombreProblema);
    }//GEN-LAST:event_formInternalFrameClosed

    private void formInternalFrameIconified(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameIconified
        this.setTitle("Vec, E5: Ayuda");
