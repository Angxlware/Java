...
public class CDF_E3_Ayuda extends javax.swing.JInternalFrame 
{   
    ...
    private void initComponents() {
        ...
        txtArMatriz.setText("- ¿Qué hace el programa?\n   Es un algoritmo que lee 3 números, los ordena de forma ascendente y los\n   muestra en pantalla.\n\n- ¿Qué datos necesito ingresar y qué significan?\n   - Número A: El valor que tomará A (Cualquier número)\n   - Número B: El valor que tomará B (Cualquier número)\n   - Número C: El valor que tomará C (Cualquier número)\n\n- ¿Qué procesos se realizan?\n   - Se ordenan los números de forma ascendente\n\n- ¿Qué datos me muestra el programa?\n   - El número menor\n   - El número intermedio\n   - El número mayor");
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        Menú_FRM.objFlujoAyudaE3 = null;
        itmFlujoAyudaE3.setEnabled(true);
        itmFlujoAyudaE3.setText(nombreProblema);
    }//GEN-LAST:event_formInternalFrameClosed

    private void formInternalFrameIconified(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameIconified
        this.setTitle("CDF, E3: Ayuda");
