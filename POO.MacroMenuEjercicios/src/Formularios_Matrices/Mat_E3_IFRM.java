...
public class Mat_E3_IFRM extends javax.swing.JInternalFrame 
{   
    public final String tema = "Matrices";
    public final String numEvidencia = "Evidencia III";
    public final String nombreProblema = "Intercambiar Col.";
    private IntercambiarCol_Interfaz objIntercambiarCol;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Intercambiar Columnas de una Matriz");
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(350, 90, 310, 20);
        ...
        jPanel1.add(jLabel6);
        jLabel6.setBounds(20, 90, 310, 20);
        ...
        jLabel8.setText("Matriz intercambiada");
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        objMatFormE3 = null;
        itmMatFormE3.setEnabled(true);
        itmMatFormE3.setText(nombreProblema);
    ...
    {        
        ...
        objIntercambiarCol = new IntercambiarCol_Clase_Base(matriz);
        objIntercambiarCol.IntercambiarColumnas();
        
        txtArMatrizB.setText(null);
        for (int i = 0; i < objIntercambiarCol.getMatriz().length; i++) {
            txtArMatrizB.append("{");
            for (int j = 0; j < objIntercambiarCol.getMatriz()[0].length; j++) {
                txtArMatrizB.append(String.valueOf(
                        objIntercambiarCol.getMatriz()[i][j]));
                if (j != (objIntercambiarCol.getMatriz()[0].length - 1)) {
                    txtArMatrizB.append(", ");
                }
            }
            txtArMatrizB.append("}\n");
