...
public class Mat_E3_Modelado extends javax.swing.JInternalFrame 
{   
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imágenes_Matrices/IntercambiarCol_Modelo_UML.png"))); // NOI18N
        jPanel3.add(jLabel2);
        jLabel2.setBounds(0, 0, 560, 240);

        jPanel1.add(jPanel3);
        jPanel3.setBounds(20, 70, 560, 240);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(20, 20, 600, 330);
        ...
        jPanel2.setBounds(20, 370, 600, 90);
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        Menú_FRM.objMatModeloE3 = null;
        itmMatModeloE3.setEnabled(true);
        itmMatModeloE3.setText(nombreProblema);
    }//GEN-LAST:event_formInternalFrameClosed

    private void formInternalFrameIconified(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameIconified
        this.setTitle("Mat, E3: Modelado");
