...
public class Vec_E2_IFRM extends javax.swing.JInternalFrame 
{   
    public final String tema = "Vectores";
    public final String numEvidencia = "Evidencia II";
    public final String nombreProblema = "Rep. May. Men.";
    private RepMayMen_Interfaz objRepMayMen;
    ...
    private void initComponents() {
        ...
        txtArPosMenor = new javax.swing.JTextArea();
        ...
        txtRepMayor = new javax.swing.JTextField();
        jLabel17 = new javax.swing.JLabel();
        txtRepMenor = new javax.swing.JTextField();
        jScrollPane3 = new javax.swing.JScrollPane();
        txtArArreglo = new javax.swing.JTextArea();
        jLabel14 = new javax.swing.JLabel();
        jScrollPane4 = new javax.swing.JScrollPane();
        txtArPosMayor = new javax.swing.JTextArea();
        ...
        jLabel1.setText("Número Mayor y Menor de un Arreglo");
        ...
        jLabel10.setBounds(20, 160, 210, 40);
        ...
        txtArPosMenor.setEditable(false);
        txtArPosMenor.setBackground(new java.awt.Color(63, 63, 63));
        txtArPosMenor.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        txtArPosMenor.setForeground(new java.awt.Color(255, 255, 255));
        txtArPosMenor.setTabSize(4);
        txtArPosMenor.setBorder(null);
        txtArPosMenor.setSelectedTextColor(new java.awt.Color(0, 0, 0));
        txtArPosMenor.setSelectionColor(new java.awt.Color(255, 255, 255));
        jScrollPane1.setViewportView(txtArPosMenor);

        jPanel3.add(jScrollPane1);
        jScrollPane1.setBounds(250, 340, 210, 50);
        ...
        jLabel13.setBounds(250, 160, 210, 40);
        ...
        jLabel15.setText("Posición(es)");
        jLabel15.setFocusable(false);
        jLabel15.setRequestFocusEnabled(false);
        jPanel3.add(jLabel15);
        jLabel15.setBounds(250, 300, 210, 40);

        jLabel16.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel16.setText("No. de Apariciones");
        jLabel16.setFocusable(false);
        jLabel16.setRequestFocusEnabled(false);
        jPanel3.add(jLabel16);
        jLabel16.setBounds(20, 230, 210, 40);

        txtRepMayor.setEditable(false);
        txtRepMayor.setBackground(new java.awt.Color(63, 63, 63));
        txtRepMayor.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
        txtRepMayor.setForeground(new java.awt.Color(255, 255, 255));
        txtRepMayor.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtRepMayor.setBorder(null);
        txtRepMayor.setCaretColor(new java.awt.Color(255, 255, 255));
        txtRepMayor.setSelectedTextColor(new java.awt.Color(33, 33, 33));
        txtRepMayor.setSelectionColor(new java.awt.Color(255, 255, 255));
        jPanel3.add(txtRepMayor);
        txtRepMayor.setBounds(20, 270, 210, 30);

        jLabel17.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel17.setText("No. de Apariciones");
        jLabel17.setFocusable(false);
        jLabel17.setRequestFocusEnabled(false);
        jPanel3.add(jLabel17);
        jLabel17.setBounds(250, 230, 210, 40);

        txtRepMenor.setEditable(false);
        txtRepMenor.setBackground(new java.awt.Color(63, 63, 63));
        txtRepMenor.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
        txtRepMenor.setForeground(new java.awt.Color(255, 255, 255));
        txtRepMenor.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtRepMenor.setBorder(null);
        txtRepMenor.setCaretColor(new java.awt.Color(255, 255, 255));
        txtRepMenor.setSelectedTextColor(new java.awt.Color(33, 33, 33));
        txtRepMenor.setSelectionColor(new java.awt.Color(255, 255, 255));
        jPanel3.add(txtRepMenor);
        txtRepMenor.setBounds(250, 270, 210, 30);
        ...
        txtArArreglo.setEditable(false);
        txtArArreglo.setBackground(new java.awt.Color(63, 63, 63));
        txtArArreglo.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        txtArArreglo.setForeground(new java.awt.Color(255, 255, 255));
        txtArArreglo.setTabSize(4);
        txtArArreglo.setBorder(null);
        txtArArreglo.setSelectedTextColor(new java.awt.Color(0, 0, 0));
        txtArArreglo.setSelectionColor(new java.awt.Color(255, 255, 255));
        jScrollPane3.setViewportView(txtArArreglo);
        ...
        jLabel14.setText("Posición(es)");
        jLabel14.setFocusable(false);
        jLabel14.setRequestFocusEnabled(false);
        jPanel3.add(jLabel14);
        jLabel14.setBounds(20, 300, 210, 40);
        ...
        txtArPosMayor.setEditable(false);
        txtArPosMayor.setBackground(new java.awt.Color(63, 63, 63));
        txtArPosMayor.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        txtArPosMayor.setForeground(new java.awt.Color(255, 255, 255));
        txtArPosMayor.setTabSize(4);
        txtArPosMayor.setBorder(null);
        txtArPosMayor.setSelectedTextColor(new java.awt.Color(0, 0, 0));
        txtArPosMayor.setSelectionColor(new java.awt.Color(255, 255, 255));
        jScrollPane4.setViewportView(txtArPosMayor);

        jPanel3.add(jScrollPane4);
        jScrollPane4.setBounds(20, 340, 210, 50);
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        objVecFormE2 = null;
        itmVecFormE2.setEnabled(true);
        itmVecFormE2.setText(nombreProblema);
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        ...
        txtRepMayor.setText(null);
        txtRepMenor.setText(null);
        txtArPosMayor.setText(null);
        txtArPosMenor.setText(null);
    ...
    {        
        ...
        if (txtNumDatos.getText().isEmpty()) {
            MostrarError(2, "Error: Campo vacío", 
                    "Llene el campo antes de generar el arreglo",
                    txtNumDatos);
            return;
        }
        ...
        objRepMayMen = new RepMayMen_Clase_Base(arreglo);
        objRepMayMen.setNumMayor();
        objRepMayMen.setNumMenor();
        objRepMayMen.setRepMayor();
        objRepMayMen.setRepMenor();
        objRepMayMen.setIndMayor();
        objRepMayMen.setIndMenor();
        
        txtArArreglo.setText(null);
        for (int i = 0; i < arreglo.length; i++) {
            txtArArreglo.append("Arreglo[" + (i + 1) + "]: " + arreglo[i] + "\n");
        }
        txtNumMayor.setText(String.valueOf(objRepMayMen.getNumMayor()));
        txtNumMenor.setText(String.valueOf(objRepMayMen.getNumMenor()));
        txtRepMayor.setText(String.valueOf(objRepMayMen.getRepMayor()));
        txtRepMenor.setText(String.valueOf(objRepMayMen.getRepMenor()));
        
        txtArPosMayor.setText(null);
        txtArPosMayor.append("[");
        for (int i = 0; i < objRepMayMen.getIndMayor().length; i++) {
            txtArPosMayor.append(String.valueOf(objRepMayMen.getIndMayor()[i]));
            if (i != (objRepMayMen.getIndMayor().length - 1))
                txtArPosMayor.append(", ");
        }
        txtArPosMayor.append("]");
        
        txtArPosMenor.setText(null);
        txtArPosMenor.append("[");
        for (int i = 0; i < objRepMayMen.getIndMenor().length; i++) {
            txtArPosMenor.append(String.valueOf(objRepMayMen.getIndMenor()[i]));
            if (i != (objRepMayMen.getIndMenor().length - 1))
                txtArPosMenor.append(", ");
        }
        txtArPosMenor.append("]");
    ...
    private javax.swing.JTextArea txtArArreglo;
    private javax.swing.JTextArea txtArPosMayor;
    private javax.swing.JTextArea txtArPosMenor;
    ...
    private javax.swing.JTextField txtRepMayor;
    private javax.swing.JTextField txtRepMenor;
