...
{   
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imágenes_Vectores/PromTemp_Modelo_UML.png"))); // NOI18N
        jPanel3.add(jLabel2);
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        Menú_FRM.objVecModeloE5 = null;
        itmVecModeloE5.setEnabled(true);
        itmVecModeloE5.setText(nombreProblema);
    }//GEN-LAST:event_formInternalFrameClosed

    private void formInternalFrameIconified(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameIconified
        this.setTitle("Vec, E5: Modelado");
