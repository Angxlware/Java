...
public class Vec_E5_IFRM extends javax.swing.JInternalFrame 
{   
    private static final DecimalFormat dcfNúmero = new DecimalFormat("###,###.##");
    public final String tema = "Vectores";
    public final String numEvidencia = "Evidencia V";
    public final String nombreProblema = "Prom. Temp.";
    private PromTemp_Interfaz objPromTemp;
    ...
    private void initComponents() {
        ...
        txtTempProm = new javax.swing.JTextField();
        ...
        jLabel1.setText("Arreglo de Temperaturas Ambientales");
        ...
        jLabel10.setText("Temperatura Promedio");
        jLabel10.setFocusable(false);
        jLabel10.setRequestFocusEnabled(false);
        jPanel3.add(jLabel10);
        jLabel10.setBounds(20, 170, 440, 30);

        jLabel12.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel12.setText("Temperaturas Generadas");
        jLabel12.setFocusable(false);
        jLabel12.setRequestFocusEnabled(false);
        jPanel3.add(jLabel12);
        jLabel12.setBounds(20, 10, 440, 40);

        txtTempProm.setEditable(false);
        txtTempProm.setBackground(new java.awt.Color(63, 63, 63));
        txtTempProm.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
        txtTempProm.setForeground(new java.awt.Color(255, 255, 255));
        txtTempProm.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtTempProm.setBorder(null);
        txtTempProm.setCaretColor(new java.awt.Color(255, 255, 255));
        txtTempProm.setSelectedTextColor(new java.awt.Color(33, 33, 33));
        txtTempProm.setSelectionColor(new java.awt.Color(255, 255, 255));
        jPanel3.add(txtTempProm);
        txtTempProm.setBounds(20, 200, 440, 30);
        ...
        jLabel18.setText("Temperaturas Superiores al Promedio");
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        objVecFormE5 = null;
        itmVecFormE5.setEnabled(true);
        itmVecFormE5.setText(nombreProblema);
    ...
    {        
        ...
        try {
            ...
            if (numDatos < 2) {
                MostrarError(0, "Error: Longitud inválida", 
                    "Los longitud del arreglo tiene que ser mayor que uno",
                    txtNumDatos);
                return;
            }
        }
        ...
        {
            arreglo[índice] = rnd.nextInt(50) + 10;
        }
        objPromTemp = new PromTemp_Clase_Base(arreglo);
        objPromTemp.setPromedio();
        objPromTemp.setContadorTemp();
        objPromTemp.setTemperaturas();
        
        txtTempProm.setText(String.valueOf(dcfNúmero.format(
                objPromTemp.getPromedio())));
        txtArArregloA.setText(null);
        ...
        txtArArregloB.setText(null);
        for (int i = 0; i < objPromTemp.getTemperaturas().length; i++) {
            txtArArregloB.append("Arreglo[" + (i + 1) + "]: " 
                    + objPromTemp.getTemperaturas()[i] + "\n");
        }
    ...
    private javax.swing.JTextField txtTempProm;
