...
public class CDF_E1_Ayuda extends javax.swing.JInternalFrame 
{   
    ...
    private void initComponents() {
        ...
        txtArMatriz.setText("- ¿Qué hace el programa?\n   Es un algoritmo que lee los valores X, A y B y retorna el valor de Y dictado\n   por la siguiente expresión:\n           / 10a - 2b Si X<0\n   Y = |   |40a - b| Si X>0 y X<=20\n           \\ |50a - 2b| Si X>20\n\n- ¿Qué datos necesito ingresar y qué significan?\n   - X: El valor que tomará X (Cualquier número que no sea 0)\n   - A: El valor que tomará A (Cualquier número)\n   - B: El valor que tomará B (Cualquier número)\n\n- ¿Qué procesos se realizan?\n   - Se calcula el valor de Y\n\n- ¿Qué datos me muestra el programa?\n   - El valor de Y");
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        Menú_FRM.objFlujoAyudaE1 = null;
        itmFlujoAyudaE1.setEnabled(true);
        itmFlujoAyudaE1.setText(nombreProblema);
    }//GEN-LAST:event_formInternalFrameClosed

    private void formInternalFrameIconified(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameIconified
        this.setTitle("CDF, E1: Ayuda");
