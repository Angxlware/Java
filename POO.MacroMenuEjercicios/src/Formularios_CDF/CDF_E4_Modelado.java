...
public class CDF_E4_Modelado extends javax.swing.JInternalFrame 
{   
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imágenes_CDF/CalcImpuestos_Modelo_UML.png"))); // NOI18N
        jPanel3.add(jLabel2);
        jLabel2.setBounds(0, 0, 560, 310);

        jPanel1.add(jPanel3);
        jPanel3.setBounds(20, 70, 560, 310);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(20, 20, 600, 400);
        ...
        jPanel2.setBounds(20, 440, 600, 90);
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        Menú_FRM.objFlujoModeloE4 = null;
        itmFlujoModeloE4.setEnabled(true);
        itmFlujoModeloE4.setText(nombreProblema);
    }//GEN-LAST:event_formInternalFrameClosed

    private void formInternalFrameIconified(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameIconified
        this.setTitle("CDF, E4: Modelado");
