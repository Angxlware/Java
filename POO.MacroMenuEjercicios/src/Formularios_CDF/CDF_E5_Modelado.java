...
public class CDF_E5_Modelado extends javax.swing.JInternalFrame 
{   
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imágenes_CDF/EvaluarLista_Modelo_UML.png"))); // NOI18N
        jPanel3.add(jLabel2);
        jLabel2.setBounds(0, 0, 560, 440);

        jPanel1.add(jPanel3);
        jPanel3.setBounds(20, 70, 560, 440);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(20, 20, 600, 530);
        ...
        jPanel2.setBounds(20, 570, 600, 90);
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        Menú_FRM.objFlujoModeloE5 = null;
        itmFlujoModeloE5.setEnabled(true);
        itmFlujoModeloE5.setText(nombreProblema);
    }//GEN-LAST:event_formInternalFrameClosed

    private void formInternalFrameIconified(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameIconified
        this.setTitle("CDF, E5: Modelado");
