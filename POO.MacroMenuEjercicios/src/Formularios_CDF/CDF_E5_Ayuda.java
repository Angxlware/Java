...
public class CDF_E5_Ayuda extends javax.swing.JInternalFrame 
{   
    ...
    private void initComponents() {
        ...
        txtArMatriz.setText("- ¿Qué hace el programa?\n   Es un algoritmo que lee una lista de datos, se ingresan los datos uno por uno\n   para posteriormente mostrar el número mayor, el número menor, la sumatoria, \n   el promedio y el rango de la lista.\n\n- ¿Qué datos necesito ingresar y qué significan?\n   - Número: El número que se añadirá a la lista (Cualquier número)\n\n- ¿Qué procesos se realizan?\n   - Se encuentra el número mayor\n   - Se encuentra el número menor\n   - Se hace la sumatoria de la lista\n   - Se calcula el promedio\n   - Se calcula el rango\n\n- ¿Qué datos me muestra el programa?\n   - El número mayor\n   - El número menor\n   - La sumatoria\n   - El promedio\n   - El rango");
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        Menú_FRM.objFlujoAyudaE5 = null;
        itmFlujoAyudaE5.setEnabled(true);
        itmFlujoAyudaE5.setText(nombreProblema);
    }//GEN-LAST:event_formInternalFrameClosed

    private void formInternalFrameIconified(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameIconified
        this.setTitle("CDF, E5: Ayuda");
