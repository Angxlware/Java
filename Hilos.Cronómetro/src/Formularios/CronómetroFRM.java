...
import Hilos.Cronómetro;
import javax.swing.UIManager;

public class CronómetroFRM extends javax.swing.JFrame {
    
    private Cronómetro hiloCronómetro;
    private int contador = 0;
    
    public CronómetroFRM() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnMarcar.setBounds(20, 20, 120, 26);
        ...
        btnIniciar.setBounds(160, 20, 120, 26);
        ...
        btnPausar.setBounds(300, 20, 120, 26);
        ...
        btnReanudar.setBounds(20, 70, 120, 26);
        ...
        btnDetener.setBounds(160, 70, 120, 26);
        ...
        jButton1.setBounds(300, 70, 120, 26);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CronómetroFRM().setVisible(true);
            }
        });
    }
