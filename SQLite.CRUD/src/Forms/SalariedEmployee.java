...
public final class SalariedEmployee extends javax.swing.JInternalFrame {
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        try {
            DATA_MANAGER.executeUpdate(String.format(""
                    + "INSERT INTO EmpleadosAsalariados "
                    + "(RFC, NOMBRE, DEPARTAMENTO, PUESTO, SUELDO)"
                    + "VALUES ('%s', '%s', '%s', '%s', '%s')",
                    txtRFC.getText(),
                    txtName.getText(),
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            DATA_MANAGER.executeUpdate(String.format(
                    "DELETE FROM EmpleadosAsalariados WHERE RFC = '%s'",
                    txtRFC.getText()));
            JOptionPane.showMessageDialog(rootPane,
        ...
        if (btnSearch.isSelected()) {
            ...
            try {
                ResultSet searchData = DATA_MANAGER.executeQuery(String.format(
                        "SELECT * FROM EmpleadosAsalariados WHERE RFC = '%s'",
                        txtRFC.getText()));
    ...
    public final void showEmployees() {
        ...
        try {
            ResultSet search = DATA_MANAGER.executeQuery(
                    "SELECT * FROM EmpleadosAsalariados");
