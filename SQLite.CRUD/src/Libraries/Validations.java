...
public class Validations {
    ...
    public static void validateName(javax.swing.JTextField txt, KeyEvent e) {
        ...
        if (txt.getText().length() >= 50) {
            JOptionPane.showMessageDialog(null,
                    "El límite de carácteres del Nombre es de 50",
                    "Límite de carácteres",
                    2);
            e.consume();
    ...
    public static void validateDepartment(javax.swing.JTextField txt, KeyEvent e) {
        char c = e.getKeyChar();

        if (txt.getText().length() >= 25) {
            JOptionPane.showMessageDialog(null,
                    "El límite de carácteres del Departamento es de 25",
                    "Límite de carácteres",
                    2);
            e.consume();
        } else if (((!Character.isLetter(c)) && (c != ' ')
    ...
    public static void validatePosition(javax.swing.JTextField txt, KeyEvent e) {
        char c = e.getKeyChar();

        if (txt.getText().length() >= 25) {
            JOptionPane.showMessageDialog(null,
                    "El límite de carácteres del Puesto es de 25",
                    "Límite de carácteres",
                    2);
            e.consume();
        } else if (((!Character.isLetter(c)) && (c != ' ')
